...
class RescheduleInterview extends Component{
    constructor(props){
        super(props);
        this.state={
                   ...
                   <section className="job-requirement">
                       <div className="col-md-6">
                           <div className="row jobrequirements">
                                  ...
                                  <p className="requirement-heading">{this.state.reschedule_interview.position}</p>
                                  <div className="col-md-4">
                                     <p className="postedon">Posted on</p>
                                     <p className="postedondate">{this.state.reschedule_interview.posted_on}</p>
                                  </div>
                                  <div className="col-md-4">
