...
class CandidateIndustry extends Component{
    constructor(props) {
        super(props);
                ...
                <div class="container">
                    <div className="col-lg-12 mdv-singup-page">
                        ...
                        <div className="stu-category ks-cboxtags">
                            ...
                            <div class="col-md-2 mm">
                                <input type="checkbox" class="single-checkbox" id="checkboxElev" />
                                 <label for="checkboxElev">
...
export default CandidateIndustry;
